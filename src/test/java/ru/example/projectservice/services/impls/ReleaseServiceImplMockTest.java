...
class ReleaseServiceImplMockTest {
    ...
    @Test
    void addReleaseNullTest() {
        Mockito.when(releaseRepository.save(Mockito.isNull())).thenThrow(BadRequestException.class);
        assertThrows(BadRequestException.class, () -> releaseService.add(null));
    }
